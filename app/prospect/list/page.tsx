        ...
        <div className=" flex flex-1 justify-between items-start px-24 py-2 gap-2">
          ...
          <div className="flex items-center justify-center">
            <Button
              ...
              onClick={() => (window.location.href = "/prospect/add")}
              className="hover:bg-secondary rounded-full hover:scale-105 hover:shadow-[0_0_5px#0a18ff] transition-all duration-300"
            >
              <Plus />
